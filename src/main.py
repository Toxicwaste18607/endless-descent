...
h2 = Walls(200, 200, 300, 50)
h3 = Walls(200, 380, 300, 50)
h4 = Walls(300, 530, 250, 50)
h5 = Walls(600, 330, 200, 50)
h6 = Walls(750, 450, 180, 50)
h7 = Walls(600, 600, 250, 50)
h8 = Walls(100, 650, 400, 50)

v1 = Walls(100, 100, 50, 200)
v2 = Walls(480, 200, 50, 200)
v3 = Walls(200, 380, 50, 150)
v4 = Walls(530, 450, 50, 100)
v5 = Walls(600, 100, 50, 250)
v6 = Walls(700, 150, 50, 250)
v7 = Walls(850, 200, 50, 270)
v8 = Walls(400, 500, 50, 170)
